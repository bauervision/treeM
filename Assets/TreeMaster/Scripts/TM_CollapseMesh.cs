...
#if UNITY_EDITOR
using UnityEditor;
public class TM_CollapseMesh : EditorWindow
{
    ...
    {
        EditorWindow editorWindow = EditorWindow.GetWindow(typeof(TM_CollapseMesh));
    ...
    void OnGUI()
    {
        ...
        if (Selection.gameObjects.Length == 1)
        {
            ...
            {
                optimizedPath = "Assets/TreeMaster/Optimized";// reset the path
            }
